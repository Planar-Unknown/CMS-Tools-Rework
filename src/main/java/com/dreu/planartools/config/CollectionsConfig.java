...
public class CollectionsConfig {
  ...
  public static final String DEEPSLATE_EXAMPLE_TEMPLATE = """
      ...
      // For example this collection can be referenced with ["@example/deepslate"] because it is [config/planar_tools/collections/blocks/example/deepslate.txt]
  ...
  public static final String GOLDEN_TOOLS_TEMPLATE = """
      // This is a collection, it can be referenced in your tools.toml using its file path after the collections folder
