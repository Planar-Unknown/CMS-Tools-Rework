...
import static com.dreu.planarcms.PlanarCMS.LOGGER;
...
public class CollectionsConfig {
  ...
  public static final String COMBAT_EXAMPLE_TEMPLATE = """
      ...
      // For example, this collection can be referenced with "@combat" because it is at [config/planar_cms/collections/enchants/combat.txt]
  ...
  public static final String DEEPSLATE_EXAMPLE_TEMPLATE = """
      ...
      // For example this collection can be referenced with ["@example/deepslate"] because it is at [config/planar_cms/collections/blocks/example/deepslate.txt]
      // File extensions (e.g., .txt, .cfg, .toml) can be anything. It doesn't matter.
  ...
  public static final String WOOD_EXAMPLE_TEMPLATE = """
      // This is a collection of blocks, it can be referenced in your blocks.toml using its file path (after the collections folder)
      // For example this collection can be referenced with ["@wood"] because it is [config/planar_cms/collections/blocks/wood.txt]
      // File extensions (e.g., .txt, .cfg, .toml) can be anything. It doesn't matter.
  ...
  public static final String GOLDEN_TOOLS_TEMPLATE = """
      ...
      // For example this collection can be referenced with ["@golden_tools"] because it is [config/planar_cms/collections/items/golden_tools.txt]
      // File extensions (e.g., .txt, .cfg, .toml) can be anything. It doesn't matter.
